...
if __name__ == '__main__':
    ...
    for step in range(0, total_records_cnt):
        # Increment by 50ms to make sure timestamps are unique for all records
    ...
    print("ENDED: isCA = {}, batch_size = {}, total_records_cnt = {}, success_records_cnt = {}, elapsed_time_sec = {}".format(is_ca, batch_size, total_records_cnt, i, elapsed_time_sec))
